...
const PRODUCTS = [
  {
    ...
    desc: "Эффективно удаляет загрязнения на кухне и в ванной...",
    ...
    descFull: "Подробное описание для аккордеона.",
    composition: "Вода, ПАВы <5%, ароматизатор, консервант.",
    usage: "Развести 50 мл на 5 л воды. Нанести, выдержать 2–3 мин, смыть.",
    specs: [
      "Объём: 500 мл",
      "Аромат: свежий",
      "Без фосфатов",
      ...
      "pH: нейтральный"
    ], // Варианты объёма этого же товара (кликабельные табы/кнопки)
    volumes: [
      { slug: "cleaner-500",  label: "500 мл", price: 390,  isCurrent: true  },
      { slug: "cleaner-1000", label: "1 л",    price: 690,  isCurrent: false },
      { slug: "cleaner-5000", label: "5 л",    price: 2490, isCurrent: false }
    ],
  },
  {
    slug: "shampoo-250",
